...
ELEVENLABS_AGENT_ID = os.getenv('AGENT_1_ID') # <--- ИЗМЕНЕНИЕ
GOOGLE_DOC_ID = os.getenv('AGENT_1_DOC_ID') # <--- ИЗМЕНЕНИЕ
GOOGLE_DRIVE_FOLDER_ID = os.getenv('AGENT_1_DRIVE_FOLDER_ID') # <--- ИЗМЕНЕНИЕ
